    ...
    <header className='container-fluid header' style={{backgroundColor: '#f4f9fc'}}>
        <div className='container wrapper'>
            <div className='row'>
                ...
                <div className='col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right header-toolbar hidden-print' style={{ paddingTop: '2rem'}}>
                    <div className='wrapper' style={{ float: 'right'}}>
                        <Link to='/'  style={{ textDecoration: 'none', color:'black'}}>
                            <strong>Fale Conosco {` | `}</strong>
                            <svg className="bi bi-envelope-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="#FDB700" xmlns="http://www.w3.org/2000/svg">
